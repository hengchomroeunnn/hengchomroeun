    ...
    <div class="pt-10">
        ...
        <div class="space-x-4 text-2xl">
            ...
            <a href="tel:+85593406289"> 
                <Icon class="hover:bg-primary hover:scale-110 transition-transform" name="tabler:phone"></Icon> 
            </a>
            <a href="mailto:chomroeun.heng@student.cadt.edu.kh">
                <Icon class="hover:bg-primary hover:scale-110 transition-transform" name="tabler:mail-filled"></Icon>
            </a>
        </div>
        <div>© Made with Love - HENG CHOMROEUN</div>
